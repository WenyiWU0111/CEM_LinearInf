...
When the covariate balance is achieved, the resulting effect estimate is less sensitive to model misspecification and ideally close to true treatment effect (:ref:`Greifer, 2023<ref1>`). 
...
*   **'L1'**: Calculate and return the L1 imbalance score. 
    ...
    L1 imbalance score was introduced by :ref:`Iacus et al. (2011)<ref2>`, and it is used to measure the difference between two multivariate distributions.
...
*   **'smd'**: Print the standardized mean difference (SMD) summary table and plots of confounders.
    ...
    SMD is a common way to measure the balance for a single covariate :math:`X`. It can be interpreted as the distance between the means of the two groups in terms of the standard deviation of the covariate’s distribution (:ref:`Zhang, et. al. 2019<ref4>`).
